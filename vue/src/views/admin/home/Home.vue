    ...
    <div class="user_home_body">
      <el-container>
        <el-aside width="200px" class="aside">
          <h3 style="color:rgb(155, 228, 255)">管理员界面</h3>
          <el-menu
              default-active="1"
              background-color="#545c64"
              text-color="#fff"
              active-text-color="#ffd04b">
            <el-menu-item index="1" @click="goClassroom()" style="text-align: left;">
              <i class="el-icon-menu"></i>
              <span slot="title">自习室座位预定</span>
            </el-menu-item>
          </el-menu>
        </el-aside>
        <el-container>
